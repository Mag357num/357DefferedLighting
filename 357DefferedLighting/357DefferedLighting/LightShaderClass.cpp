...
bool LightShaderClass::Render( ID3D11DeviceContext* d3dDeviceContext, int indexCount, CXMMATRIX worldMatrix, CXMMATRIX viewMatrix, CXMMATRIX ProjMatrix,
	ID3D11ShaderResourceView* ColorTexture, ID3D11ShaderResourceView* NormalTexture, FXMVECTOR diffuseColor, FXMVECTOR LightDirection )
{
	bool result;
...
bool LightShaderClass::SetShaderParameter( ID3D11DeviceContext* d3dDeviceContext, CXMMATRIX worldMatrix, CXMMATRIX viewMatrix, CXMMATRIX ProjMatrix,
	ID3D11ShaderResourceView* ColorTexture, ID3D11ShaderResourceView* NormalTexture, FXMVECTOR diffuseColor, FXMVECTOR LightDirection )
{
